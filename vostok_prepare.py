...
path = r"C:\Users\admin\Desktop\GRAZ\metashape\graz_dense_medium_subsample.csv"
df = pd.read_csv(path)
...
new_df.to_csv('r"C:\Users\admin\Desktop\GRAZ\metashape\vostok_input.csv"', index=False)